...
```{r}
#A dataframe is functionally synonymous with a an excel spreadsheet, it has columns and rows and data inside
...
pnorm((35-40)/2, lower.tail = FALSE)
...
prob_one = 1 - pnorm((.2515-.2508)/.0005, lower.tail = F) #F is the same as FALSE
prob_two = 1 - pnorm((.2485 - .2508)/.0005, lower.tail = F)
...
prob_one = ( .2515-.25 ) / .0005
prob_two = ( .2485 - .25) / .0005
